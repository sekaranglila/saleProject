<%-- 
    Document   : sales.jsp
    Created on : Nov 8, 2016, 2:55:26 PM
    Author     : Kris
--%>
...
<html>
        ...
        <div class = "container">
            ...
            <table border="1" class="nav-menu">
                <tr>
                    ...
                    <th class = "padth navth"><a href="sales.jsp" class = "white">Sales</a></th>
    ...
    <%
            ...
            try {
                ...
                result = port.getSalesProductByUserID(Integer.parseInt(idu));
            } catch (Exception ex) {
                out.println("None");
            }
                    ...
                    <table class="tableShow">
                        ...
                        <td style="width:50%" valign="top">
                            <div style="font-size: 15px"><b><% out.println(result.get(4).getItem().get(i));%></b><br>
                                ...
                                bought by <b><% out.println(result.get(5).getItem().get(i));%></b>
                        </td>
                        <td valign="top">
